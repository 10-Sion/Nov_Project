...
//				List<AnnouncementsVO> membersList = moonUiService.serviceGongiList(startRow,pageSize);
...
//				request.setAttribute("membersList", membersList);
				...
				moonUiService.addGongiList(post_title,post_content);
				...
				moonUiService.delGongiList(announcement_id);
				nextPage = "/gongiBoard/gongiList.do";
				...
				moonUiService.modifyGongiList(announcement_id,post_title,post_content);
				...
				moonUiService.serviceViewCountUpdate(announcement_id);
			  AnnouncementsVO vo = moonUiService.serviceListOne(announcement_id);
